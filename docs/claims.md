...
| C-004 | 28-skill install verified post-`handsfree` | UNVERIFIED | — (last verified install predates `handsfree`; re-run required) | — | clean dir + CLI `--all`, record output | must clear before v1.0 |
