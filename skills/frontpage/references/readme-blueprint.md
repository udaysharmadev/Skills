...
| Quick start | shortest verified path to first success; put it high |
...
- No marketing fog. A performance statement needs a reproducible workload,
  method, observed result, and date.
- Version requirements carry the exact tested or declared source.
