...
Rules: keep this snapshot short enough to scan before acting. Replace it on
each session delta and bump the update date. Blockers and next steps carry an
expiry condition, which may be a date, milestone, or superseding event. Detail
lives in owning artifacts and STATUS points at them.
